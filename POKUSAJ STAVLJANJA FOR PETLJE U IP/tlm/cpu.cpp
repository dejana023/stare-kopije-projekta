...
void Cpu::makeDescriptor() {
  ...
  /*     write_hard_double(addr_sine, _sine);                                                  cout << "_cose CPU: " << _cose << endl;
  write_hard_double(addr_cose, _cose);                             			 cout << "_sine CPU: " << _sine << endl;
      cout << "bla" << endl;*/
      
     double scale1 = 1.65*(1+_doubleImage)*_current->scale;
     double row = (1+_doubleImage)*_current->y;
     double col = (1+_doubleImage)*_current->x;
   ...
   /* createVector(1.65*(1+_doubleImage)*_current->scale,
        ...
        write_hard_double(addr_scale1, scale1);
            //cout << "bla" << endl;
        write_hard_double(addr_row, row);
            cout << "bla" << endl;
        write_hard_double(addr_col, col);
            cout << "bla" << endl;
