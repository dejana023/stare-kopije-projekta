...
void Cpu::createVector(double scale, double row, double col) {
  ...
  pixels1D = new num_f[_width * _height];
         ...
         // write_hard_int(addr_scale1, scale1);
          ...
          write_hard_int(addr_ix, ix);
                ...
                //   cout << "_cose CPU: " << _cose << endl;
                 ...
                 write_hard_double(addr_fracy, fracy);
          
                  //  cout << "step CPU: " << step << endl;
          
          write_hard_double(addr_fracx, fracx);
          ...
          write_hard_double(addr_iradius, iradius);
          
                //   cout << "_cose CPU: " << _cose << endl;
                
                write_hard_double(addr_scale, scale);
