...
SC_MODULE(Cpu)
{
	...
	protected:
		...
		double get_sum(double** I, int x1, int y1, int x2, int y2);
    double get_wavelet1(double** IPatch, int x, int y, double size);
    double get_wavelet2(double** IPatch, int x, int y, double size);
